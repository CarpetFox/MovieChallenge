...
import { Button, CircularProgress, debounce, FormControl, InputLabel, MenuItem, Paper, Select, SelectChangeEvent, TextField } from '@mui/material';
...
function Movies() {
    ...
    useEffect(() => {
        const loadGenres = async () => {
            setDataLoading(true);
            await fetch('movie/getGenres').then(async response => {
                handleResponse(response, enqueueSnackbar, 'There was an error loading the Genres.', async () => {
